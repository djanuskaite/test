...
public class SearchActivity extends AppCompatActivity {
    public static final String COVID_API = "https://restcountries.eu/rest/v2/all";
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            ArrayList<Corona> coronaListByQuery = JSON.getCoronaListByQuery(coronaList, query);

            if (coronaListByQuery.size() == 0) {
            ...
            adapter = new Adapter(SearchActivity.this, coronaListByQuery);
